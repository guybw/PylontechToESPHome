...
SYSTEM_SENSORS: tuple[PylontechSystemSensorDescription, ...] = (
    ...
    PylontechSystemSensorDescription(
        key="system_recommend_charge_voltage",
        translation_key="system_recommend_charge_voltage",
        native_unit_of_measurement=UnitOfElectricPotential.VOLT,
        device_class=SensorDeviceClass.VOLTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=_sys("system_recommend_charge_voltage"),
    ),
    PylontechSystemSensorDescription(
        key="system_recommend_discharge_voltage",
        translation_key="system_recommend_discharge_voltage",
        native_unit_of_measurement=UnitOfElectricPotential.VOLT,
        device_class=SensorDeviceClass.VOLTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=_sys("system_recommend_discharge_voltage"),
    ),
    PylontechSystemSensorDescription(
        key="system_recommend_charge_current",
        translation_key="system_recommend_charge_current",
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        device_class=SensorDeviceClass.CURRENT,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=_sys("system_recommend_charge_current"),
    ),
    PylontechSystemSensorDescription(
        key="system_recommend_discharge_current",
        translation_key="system_recommend_discharge_current",
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        device_class=SensorDeviceClass.CURRENT,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=_sys("system_recommend_discharge_current"),
    ),
    PylontechSystemSensorDescription(
        key="modules_present",
